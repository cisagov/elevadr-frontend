  ...
  return (
    ...
    >
      <div className="data-grid">
        <div className="data-item linked" onClick={() => handleLinkClick('service-count-panel')}>
        ...
        <div className="data-item linked" onClick={() => handleLinkClick('ot-services-panel')}>
          <span className="data-label">
        ...
        <div className="data-item linked" onClick={() => handleLinkClick('service-risk-breakdown-panel')}>
          <span className="data-label">
            <InfoTooltip text="Services associated with security risks. Click to see details." />
            Risky Services
          </span>
          <span className="data-value data-value-warning">{data.num_risky_services}</span>
        </div>
        <div className="data-item linked" onClick={() => handleLinkClick('service-count-panel')}>
          <span className="data-label">
          ...
          <span className="data-value data-value-warning">{data.num_unknown_services}</span>
        </div>
      </div>
    </Panel>
  );
