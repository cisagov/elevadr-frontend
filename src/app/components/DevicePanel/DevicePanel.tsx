...
const DevicePanel: React.FC<DevicePanelProps> = ({ data }) => {
  ...
  const isEmpty = data.hosts === 0 && data.ot_hosts === 0 && data.it_hosts === 0 && data.edge_hosts === 0 && data.ot_cross_segment === 0;
  ...
  return (
    ...
    >
      <div className="data-grid">
        <div className="data-item linked" onClick={() => handleLinkClick('devices-panel')}>
        ...
        <div className="data-item linked" onClick={() => handleLinkClick('ot-devices-panel')}>
          <span className="data-label">
        ...
        <div className="data-item linked" onClick={() => handleLinkClick('it-devices-panel')}>
          <span className="data-label">
        ...
        <div className="data-item linked" onClick={() => handleLinkClick('edge-devices-panel')}>
          <span className="data-label">
        ...
        <div className="data-item linked" onClick={() => handleLinkClick('ot-cross-segment-panel')}>
          <span className="data-label">
          ...
          <span className="data-value data-value-warning">{data.ot_cross_segment}</span>
        </div>
      </div>
    </Panel>
  );
